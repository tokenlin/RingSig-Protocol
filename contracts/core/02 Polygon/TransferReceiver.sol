...
contract TransferReceiver is CCIPReceiver {
    ...
    function _ccipReceive(
        ...
        require(_senderFromData == sender, "only accept sender from source chain");
        
        (bool success, bytes memory data) = pool.call(any2EvmMessage.data);
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            "setDataFromTransferReceiver Failed"
        );
        ...
        emit MessageReceived(
            ...
            _senderFromData,  // sender from source chain
